...
def update_person(name: str, field: str, new_value: str):
    """
    Cập nhật thông tin cá nhân của một người đã có trong hệ thống.
    
    Args:
        name: Tên người cần cập nhật
        field: Trường cần cập nhật (email, phone, address, occupation, hobby, quote, favorite_color)  
        new_value: Giá trị mới
        
    Returns:
        Dict with update status và thông tin chi tiết
        
    Examples:
        - update_person("Hang", "email", "hang.new@email.com")
        - update_person("Minh", "phone", "0987123456")  
        - update_person("Hang", "địa chỉ", "789 Đường Võ Văn Tần, Quận 3, TP.HCM")
    """
    ...
    return {
        ...
        "updated_profile": build_profile(key)
    }
