...
def add_person(
    ...
    Args:
        name: Tên của người (bắt buộc)
        age: Tuổi của người (bắt buộc)
        birthday: Ngày sinh theo định dạng dd/mm (bắt buộc)
        email: Địa chỉ email (bắt buộc)
        phone: Số điện thoại (bắt buộc)
        address: Địa chỉ (tùy chọn)
        occupation: Nghề nghiệp (tùy chọn)
        work_experience_years: Số năm kinh nghiệm làm việc (tùy chọn, mặc định 0)
        father: Tên cha (tùy chọn)
        mother: Tên mẹ (tùy chọn)
        siblings: Tên anh/chị/em (tùy chọn)
        hobby: Sở thích (tùy chọn)
        quote: Câu nói yêu thích (tùy chọn)
        favorite_color: Màu sắc yêu thích (tùy chọn)
    
    Returns:
        Dict thông báo kết quả thêm người mới
    """
